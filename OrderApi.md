...
const request: OrderApiOrderInfoRequest = {
  ...
  roundingPrecision: 3,
    // Indicates whether custom (user-defined) order statuses should be included in the response. (optional)
  allowUserDefinedOrderStatuses: true,
};
 ...
 **allowUserDefinedOrderStatuses** | [**boolean**] | Indicates whether custom (user-defined) order statuses should be included in the response. | (optional) defaults to false
