 ...
 * Applies apiKey authentication to the request context.
 */
export class StoreKeyAuthAuthentication implements SecurityAuthentication {
    /**
     * Configures this api key authentication with the necessary properties
     *
     * @param apiKey: The api key to be used for every request
    ...
    public applySecurityAuthentication(context: RequestContext) {
        context.setHeaderParam("x-store-key", this.apiKey);
    }
}
...
export type AuthMethods = {
    ...
    "StoreKeyAuth"?: SecurityAuthentication
}
...
export type AuthMethodsConfiguration = {
    ...
    "StoreKeyAuth"?: ApiKeyConfiguration
}
...
export function configureAuthMethods(config: AuthMethodsConfiguration | undefined): AuthMethods {
    ...
    if (config["StoreKeyAuth"]) {
        authMethods["StoreKeyAuth"] = new StoreKeyAuthAuthentication(
            config["StoreKeyAuth"]
        );
    }
