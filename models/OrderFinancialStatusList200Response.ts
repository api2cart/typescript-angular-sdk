...
export class OrderFinancialStatusList200Response {
    'returnCode'?: number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "result",
            "baseName": "result",
            "type": "OrderFinancialStatusList200ResponseResult",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return OrderFinancialStatusList200Response.attributeTypeMap;
    }
